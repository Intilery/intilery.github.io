...
Before you start implementing the Intilery video spec, you should understand the overall structure and classification of events. The video spec will be organized into **three** distinct event categories:
...
When you fire a [Video Playback Resumed](#video-playback-resumed) event, you *should* immediately call a Intilery heartbeat event ([Video Content Playing](#video-content-playing) or [Video Ad Playing](#video-ad-playing) depending on what the playback resumed to). This should effectively mean that you are also resuming your 10 second heartbeats (since they should’ve been paused after sending Video Playback Paused event).
...
analytics.track('Video Ad Started', {
  ...
  pod_id: 'adSegA',
  type: 'mid-roll',
  title: 'Intilery Connection Modes',
  publisher: 'Intilery',
  position: 0,
  total_length: 21,
  load_type: 'dynamic'
...
analytics.track('Video Ad Started', {
  ...
  pod_id: 'adSegB',
  type: 'post-roll',
  title: 'Intilery Cross Domain IDs',
  publisher: 'Intilery',
  position: 0,
  total_length: 11,
  load_type: 'dynamic'
